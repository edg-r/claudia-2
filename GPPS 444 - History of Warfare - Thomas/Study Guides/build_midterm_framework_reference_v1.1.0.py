...
OUT = "GPPS_444_Midterm_Framework_Reference_v1.1.0.pdf"
DOC_TITLE = "GPPS 444 Midterm Framework Reference v1.1.0"
...
visual_specs = {
    "thomas_battle_analysis": {
        ...
        "asset": f"{ASSET_DIR}/01_thomas_battle_analysis.png",
    ...
    "western_way_war": {
        ...
        "asset": f"{ASSET_DIR}/02_western_way_war.png",
    ...
    "hoplite_phalanx": {
        ...
        "asset": f"{ASSET_DIR}/03_hoplite_phalanx.png",
    ...
    "roman_adaptation": {
        ...
        "asset": f"{ASSET_DIR}/04_roman_adaptation.png",
    ...
    "fortress_siege": {
        ...
        "asset": f"{ASSET_DIR}/05_fortress_siege.png",
    ...
    "chevauchee": {
        ...
        "asset": f"{ASSET_DIR}/06_chevauchee.png",
    ...
    "infantry_revolution": {
        ...
        "asset": f"{ASSET_DIR}/07_infantry_revolution.png",
...
def visual_slot(fw, width):
    ...
    graph = Paragraph(
        f"<b>CONCEPTUAL GRAPH</b><br/>{spec['graph']}",
        styles["VisualBody"],
    )
    prompt = Paragraph(
        f"<b>IMAGEGEN SLOT</b><br/>Planned asset: <font color='#2C5282'>{spec['asset']}</font><br/>{spec['prompt']}",
        styles["VisualBody"],
    )
    t = Table([[graph, prompt]], colWidths=[width * 0.36, width * 0.64])
    t.setStyle(
        TableStyle(
            [
                ("VALIGN", (0, 0), (-1, -1), "TOP"),
...
def build():
    ...
    desc = Table(
        [[
            para(
                "Exam-ready midterm reference built from existing Ares study guides, Thomas's course framework, the extracted syllabus, machine-readable slides, and the Parker-edited TCHW text. Version 1.1.0 keeps the framework-page architecture while adding imagegen-ready conceptual visual slots, compact graph statements, and ELI5 conclusions for fast recall.",
                "Small",
            )
        ]],
        colWidths=[width],
