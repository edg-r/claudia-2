...
- `02 Areas/2025-2027 UCSD GPS/2026-4 Spring Quarter/GPCO 403 - Intl Econ - Handley/Course Admin/GPCO 403 Syllabus 2026_post.pdf` - canonical Spring 2026 syllabus; extracted with `pdftotext -layout`.
- `_claudia/claudia.db` - current `courses`, `assignments`, and `readings` rows for `course_id=1`.
- `02 Areas/2025-2027 UCSD GPS/2026-4 Spring Quarter/GPCO 403 - Intl Econ - Handley/_agent/AGENT_CONTEXT.md` - Plutus course memory.
- `02 Areas/2025-2027 UCSD GPS/2026-4 Spring Quarter/GPCO 403 - Intl Econ - Handley/_agent/ASSIGNMENTS.md` - local assignment tracker.
