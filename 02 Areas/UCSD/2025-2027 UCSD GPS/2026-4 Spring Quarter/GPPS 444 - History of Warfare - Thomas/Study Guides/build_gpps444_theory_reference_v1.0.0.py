...
OUT = "GPPS444_theory_reference_v1.0.0.pdf"
DOC_TITLE = "GPPS 444 Theory Reference v1.0.0"
ASSET_DIR = Path("assets/gpps444_theory_reference_v1.0.0")
...
styles.add(ParagraphStyle(name="Body", parent=styles["Normal"], fontSize=7.15, leading=8.45, spaceAfter=2))
styles.add(ParagraphStyle(name="Small", parent=styles["Normal"], fontSize=6.55, leading=7.6, spaceAfter=1.5))
styles.add(ParagraphStyle(name="Tiny", parent=styles["Normal"], fontSize=5.9, leading=6.8, textColor=colors.HexColor("#555555")))
...
def build_theory(story, theory, idx, width):
    ...
    story.append(Spacer(1, 5))
    story.append(RLImage(str(img_path), width=6.95 * inch, height=3.9 * inch))
    ...
    story.append(two_col("WEAKNESSES", theory["weaknesses"], "APA REFERENCES / UNIT DISCLOSURE", [
        ...
        "Generated for Edgar Agunias on 2026-05-31 by Ares using GPT-5 Codex and course-local sources.",
