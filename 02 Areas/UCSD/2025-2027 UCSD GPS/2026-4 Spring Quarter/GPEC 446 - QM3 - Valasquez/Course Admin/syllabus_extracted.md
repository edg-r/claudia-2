...
- `02 Areas/2025-2027 UCSD GPS/2026-4 Spring Quarter/GPEC 446 - QM3 - Valasquez/Course Admin/QM3_Syllabus.pdf` - canonical syllabus for GPEC 446 / Applied Data Analysis and Statistical Decision Making.
- `_claudia/claudia.db` - current `courses`, `assignments`, and `readings` rows for course_id `3` / `GPEC 446`.
- `02 Areas/2025-2027 UCSD GPS/2026-4 Spring Quarter/GPEC 446 - QM3 - Valasquez/_agent/AGENT_CONTEXT.md` - Tyche memory, especially the warning that folder week labels and syllabus week labels diverge.
...
|---:|---|---|---|---:|---|---|
| 1 | Week 1 | Angrist & Pischke, *Mastering 'Metrics*, Ch. 1 | `02 Areas/2025-2027 UCSD GPS/2026-4 Spring Quarter/GPEC 446 - QM3 - Valasquez/Course Admin/Joshua D. Angrist, Jörn-Steffen Pischke - Mastering 'Metrics_ The Path from Cause to Effect (2014, Princeton University Press).pdf` | 46 | Suggested | Causality and quantitative analysis: selection, random assignment, intro regression. DB row 13 matches topic and chapter. |
