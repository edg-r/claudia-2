...
Superseded AI-generated or iterative artifacts now belong in `02 Areas/2025-2027 UCSD GPS/2026-4 Spring Quarter/GPEC 446 - QM3 - Valasquez/.archive/<project_slug>/`, with mappings in `02 Areas/2025-2027 UCSD GPS/2026-4 Spring Quarter/GPEC 446 - QM3 - Valasquez/.archive/ARCHIVE_INDEX.md`. Keep source/professor files, final submitted files, and the latest active working/clean/submission candidate visible in the course folder. Check the course archive index before restoring or recreating older study guides, methods references, notes sidecars, scripts, or homework outputs.
