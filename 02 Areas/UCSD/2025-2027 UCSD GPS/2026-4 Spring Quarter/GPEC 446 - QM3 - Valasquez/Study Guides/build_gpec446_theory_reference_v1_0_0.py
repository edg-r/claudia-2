...
COURSE = BASE.parent
PROJECT = "gpec446_theory_reference_v1.0.0"
ASSET_DIR = BASE / "assets" / PROJECT
OUT = BASE / "GPEC446_theory_reference_v1.0.0.pdf"
NOTES = BASE / "GPEC446_theory_reference_v1.0.0_notes.md"
...
def build_story(image_paths):
    ...
    for unit in UNITS:
        ...
        img = RLImage(str(image_paths[unit["anchor"]]), width=6.85 * inch, height=3.72 * inch)
        ...
        story.append(Paragraph("<b>Key concepts and terminology</b>", styles["Section"]))
        story.append(bullets(unit["terms"], styles["Body"]))
        story.append(Paragraph("<b>Assumptions</b>", styles["Section"]))
        story.append(bullets(unit["assumptions"], styles["Body"]))
        story.append(Paragraph("<b>Strengths, diagnostics, and limitations</b>", styles["Section"]))
    ...
    story += [
        ...
        Paragraph("Generated for: Edgar Agunias<br/>Date: 2026-05-31<br/>Model: GPT-5 Codex<br/>Sources: GPEC 446 syllabus, lecture slides L1-L10, labs and handouts, Tyche memory and concept notes, existing QM3 midterm methods/lecture references, Angrist & Pischke, Gerber & Green, Wooldridge, and cited method references.<br/>Agent: Tyche", styles["Small"]),
    ]
    return story
...
def write_notes():
    lines = [
        "# GPEC446_theory_reference_v1.0.0 Notes",
        "",
        "## Sources checked",
