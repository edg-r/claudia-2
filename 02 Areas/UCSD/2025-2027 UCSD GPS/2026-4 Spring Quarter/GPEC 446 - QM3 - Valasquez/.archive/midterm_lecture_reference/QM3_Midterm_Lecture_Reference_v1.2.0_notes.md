# Quantitative Methods 3 (QM3) Midterm Lecture Reference v1.2.0

This reference sheet is built from the QM3 lecture slides, not the textbook-centered methods guide. The v1.2.0 revision keeps the narrative exam-facing approach from v1.1.0, but rebuilds the PDF for readability: 12-point body text, 1-inch margins, more white space, and original visual aids for the comparison logic behind the major methods.
...
Sources: QM3 lecture slides L1-L6 (`QM3_L1_Intro.pdf`, `QM3_L2_CaInf.pdf`, `QM3_L3_Reg.pdf`, `QM3_L4_Reg2.pdf`, `QM3_L5_IV.pdf`, `QM3_L6_IV2.pdf`); `QM3_Midterm_Lecture_Reference_v1.1.0_notes.md`; original code-generated visual aids; Tyche memory files
Agent: Tyche
---
