...
if (!file.exists(file.path(base_dir, "Africa_GDP.Rda"))) {
  base_dir <- "/Users/edgar/Documents/000 Files/02 Areas/2025-2027 UCSD GPS/2026-4 Spring Quarter/GPEC 446 - QM3 - Valasquez/Assignments/Homework 2"
}
...
event_coef_plot_data <- bind_rows(
  ...
  arrange(leadlag)
write_csv(event_coef_plot_data, file.path(out_dir, "event_study_leadlag_coefficients.csv"))
