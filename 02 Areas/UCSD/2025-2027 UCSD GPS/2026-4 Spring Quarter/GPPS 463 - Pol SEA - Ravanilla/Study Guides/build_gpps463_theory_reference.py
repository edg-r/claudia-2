...
ASSET_DIR = BASE_DIR / "assets" / "gpps463_theory_reference_v1.0.0"
PDF_PATH = BASE_DIR / "GPPS463_theory_reference_v1.0.0.pdf"
VERSION = "v1.0.0"
...
def disclosure_page():
    ...
    story = [
        ...
        Paragraph(f"Generated for: Edgar Agunias<br/>Date: 2026-05-31<br/>Model: {MODEL_PROVENANCE}<br/>Sources: {inline(source_summary)}<br/>Agent: Poseidon", STYLES["Body"]),
    ]
    return story
